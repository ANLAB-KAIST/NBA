...
io_threads = [
    ...
    nba.IOThread(core_id=node_cpus[0][0], attached_rxqs=[(4, 0), (5, 0), (6, 0), (7, 0)], mode='normal'),
    nba.IOThread(core_id=node_cpus[0][1], attached_rxqs=[(4, 1), (5, 1), (6, 1), (7, 1)], mode='normal'),
    nba.IOThread(core_id=node_cpus[0][2], attached_rxqs=[(4, 2), (5, 2), (6, 2), (7, 2)], mode='normal'),
    nba.IOThread(core_id=node_cpus[0][3], attached_rxqs=[(4, 3), (5, 3), (6, 3), (7, 3)], mode='normal'),
    nba.IOThread(core_id=node_cpus[0][4], attached_rxqs=[(4, 4), (5, 4), (6, 4), (7, 4)], mode='normal'),
    nba.IOThread(core_id=node_cpus[0][5], attached_rxqs=[(4, 5), (5, 5), (6, 5), (7, 5)], mode='normal'),
    nba.IOThread(core_id=node_cpus[0][6], attached_rxqs=[(4, 6), (5, 6), (6, 6), (7, 6)], mode='normal'),
]
comp_threads = [
    # core_id
