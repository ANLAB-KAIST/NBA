...
print("IO batch size: {0} packets, computation batch size: {1} packets".format(
      system_params['IO_BATCH_SIZE'], system_params['COMP_BATCH_SIZE']))
...
io_threads = [
    ...
    nba.IOThread(core_id=node_cpus[1][4], attached_rxqs=[(4, 4), (5, 4), (6, 4), (7, 4)], mode='normal'),
    nba.IOThread(core_id=node_cpus[1][5], attached_rxqs=[(4, 5), (5, 5), (6, 5), (7, 5)], mode='normal'),
    nba.IOThread(core_id=node_cpus[1][6], attached_rxqs=[(4, 6), (5, 6), (6, 6), (7, 6)], mode='normal'),
]
comp_threads = [
    # core_id
    ...
    nba.CompThread(core_id=node_cpus[1][4] + _ht_diff),
    nba.CompThread(core_id=node_cpus[1][5] + _ht_diff),
    nba.CompThread(core_id=node_cpus[1][6] + _ht_diff),
]
