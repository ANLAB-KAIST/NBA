...
public:
    IPsecHMACSHA1AES(): OffloadableElement()
    {
        #ifdef USE_CUDA
    ...
    const char *class_name() const { return "IPsecHMACSHA1AES"; }
...
protected:
    ...
    struct hmac_aes_sa_entry *h_key_array = NULL;       // used in CPU.
...
EXPORT_ELEMENT(IPsecHMACSHA1AES);
